...
Bezpieczeństwo — hasła użytkowników są przechowywane w bazie danych wyłącznie w postaci zahashowanej (bcrypt). Dane wejściowe są filtrowane i walidowane po stronie serwera w celu ochrony przed atakami SQL Injection i XSS.
